...
╚═════╝░╚═════╝░░╚════╝░╚═════╝░
	...
	thread = input ('Введите кол-во потоков (по умолчанию 800): ')
	...
	if proxy.strip () == '':
		get_proxy ('https://api.proxyscrape.com/?request=displayproxies&proxytype=http&timeout=5000&country=all&anonymity=elite&ssl=yes')
		proxy = 'proxies.txt'
